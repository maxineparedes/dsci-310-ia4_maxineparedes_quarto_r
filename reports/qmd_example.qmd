...
See @fig-horses for an illustration.
...
We present the standard deviations in tbl-horses-info.

```{r}
#| label: tbl-horses-info
...
Additionally, note that in @tbl-horses-info we consider the sample standard deviation of the number of horses during the same time span as @fig-horses.
...
See @fig-sd for an illustration.

In @fig-sd  we zoom in and look at the province of ```{r}
largest_sd
